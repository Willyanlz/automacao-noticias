...
As noticias possuem campo dia. Se duas ou mais noticias forem sobre o mesmo tema, empresa ou evento, UNIFIQUE em um so bloco, combinando as informacoes que se complementam entre elas, em vez de repetir o assunto separadamente.

Organize o resumao em blocos por categoria/assunto relevante. Para cada bloco, use um titulo curto de categoria/assunto e escreva um resumo corrido. Diga primeiro quem fez o que, depois o contexto, e por fim explique o possivel impacto para mercado, empresas, juros, inflacao, cambio, bolsa ou investidores — sempre com base apenas no que estiver nas noticias, sem inventar fatos, numeros ou causas.

Escreva em portugues brasileiro, didatico e natural. Sem links, sem lista numerada e sem emojis por noticia. Retorne apenas conteudo relevante para investidores.";
